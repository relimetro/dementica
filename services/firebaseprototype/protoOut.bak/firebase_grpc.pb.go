...
const (
	Serv_Login_FullMethodName         = "/firebaseprototype.serv/Login"
	Serv_GetDetails_FullMethodName    = "/firebaseprototype.serv/getDetails"
	Serv_GetRisk_FullMethodName       = "/firebaseprototype.serv/getRisk"
	Serv_SendLifestyle_FullMethodName = "/firebaseprototype.serv/SendLifestyle"
)
...
// UnimplementedServServer must be embedded to have
...
func (UnimplementedServServer) testEmbeddedByValue()              {}
...
func RegisterServServer(s grpc.ServiceRegistrar, srv ServServer) {
	// If the following call pancis, it indicates UnimplementedServServer was
...
var Serv_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "firebaseprototype.serv",
