...
const file_user_service_proto_rawDesc = "" +
	...
	"\rrelated_users\x18\x01 \x03(\v2\x19.user_service.RelatedUserR\frelatedUsers\"/\n" +
...
var file_user_service_proto_goTypes = []any{
	...
	(*VerifyTokenRequest)(nil),    // 8: user_service.VerifyTokenRequest
	(*VerifyTokenResponse)(nil),   // 9: user_service.VerifyTokenResponse
}
var file_user_service_proto_depIdxs = []int32{
	...
	0, // 2: user_service.UserService.SignUp:input_type -> user_service.SignUpRequest
	3, // 3: user_service.UserService.LinkUser:input_type -> user_service.LinkUserRequest
	5, // 4: user_service.UserService.GetLinkedUsers:input_type -> user_service.GetLinkedUsersRequest
	8, // 5: user_service.UserService.VerifyTokenRemote:input_type -> user_service.VerifyTokenRequest
	2, // 6: user_service.UserService.Login:output_type -> user_service.AuthReply
	2, // 7: user_service.UserService.SignUp:output_type -> user_service.AuthReply
	4, // 8: user_service.UserService.LinkUser:output_type -> user_service.LinkUserReply
	7, // 9: user_service.UserService.GetLinkedUsers:output_type -> user_service.GetLinkedUsersReply
	9, // 10: user_service.UserService.VerifyTokenRemote:output_type -> user_service.VerifyTokenResponse
